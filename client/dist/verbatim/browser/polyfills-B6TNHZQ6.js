    ...
    class e {
        ...
        runTask(s, i, r) {
            ...
            let E = s,
                {
                    type: x,
                    data: { isPeriodic: ee = !1, isRefreshable: M = !1 } = {},
                } = s;
    ...
    class f {
        ...
        constructor(s, i, r) {
            ((this._zone = s),
                ...
                (this._forkCurrZone =
                    r && (r.onFork ? this._zone : i._forkCurrZone)),
                (this._interceptZS = r && (r.onIntercept ? r : i._interceptZS)),
                (this._interceptDlgt =
                    r && (r.onIntercept ? i : i._interceptDlgt)),
                ...
                (this._handleErrorZS =
                    r && (r.onHandleError ? r : i._handleErrorZS)),
                (this._handleErrorDlgt =
                    r && (r.onHandleError ? i : i._handleErrorDlgt)),
                (this._handleErrorCurrZone =
                    r &&
                    (r.onHandleError ? this._zone : i._handleErrorCurrZone)),
                ...
                (this._scheduleTaskCurrZone =
                    r &&
                    (r.onScheduleTask ? this._zone : i._scheduleTaskCurrZone)),
                (this._invokeTaskZS =
                    r && (r.onInvokeTask ? r : i._invokeTaskZS)),
                (this._invokeTaskDlgt =
                    r && (r.onInvokeTask ? i : i._invokeTaskDlgt)),
                (this._invokeTaskCurrZone =
                    r && (r.onInvokeTask ? this._zone : i._invokeTaskCurrZone)),
                (this._cancelTaskZS =
                    r && (r.onCancelTask ? r : i._cancelTaskZS)),
                (this._cancelTaskDlgt =
                    r && (r.onCancelTask ? i : i._cancelTaskDlgt)),
                ...
                c.forEach(function (_) {
                    ...
                    try {
                        if (L.hasOwnProperty(_)) {
                            ...
                            H && H.value
                                ? ((H.value = t.wrapWithCurrentZone(
                                      H.value,
                                      P,
                                  )),
                                  t._redefineProperty(y.prototype, _, H))
                                : L[_] &&
                                  (L[_] = t.wrapWithCurrentZone(L[_], P));
